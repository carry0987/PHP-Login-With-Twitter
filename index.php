...
if (isset($_SESSION['status']) && $_SESSION['status'] == 'verified' && !empty($_SESSION['request_vars'])) {
    ...
    if ($twClient->http_code == '200') {
        ...
        $output = '<a href="'.filter_var($authUrl, FILTER_SANITIZE_URL).'"><img src="image/sign-in-with-twitter.svg" border="0" alt="sign-in-with-twitter" /></a>';
    }else{
...
<head>
    <meta charset="UTF-8">
    <title>Login with Twitter using PHP by carry0987</title>
